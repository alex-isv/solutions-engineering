...
>[!NOTE]
> That *console* prereq. as well as any additional custom paramethers such as users creation or networking for the cluster can be modified by cusomizing the original .raw Micro image  with [SUSE Edge Image builder](https://github.com/suse-edge/edge-image-builder/blob/main/docs/building-images.md) tool.
> 
